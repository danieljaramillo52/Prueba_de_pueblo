...
public class ListaRestaurantes extends AppCompatActivity {
    ...
    public void crearlista() {
        listaRestaurantes.add(new MoldeRestaurantes("250000", "Restaurante divino tesoro", R.drawable.restasurante4jpg, "Somos el mejor restaurante de sonson platos típicos, de toda colombia a los que tenemos acceso gracias a nuestros pisos termicos"));
        listaRestaurantes.add(new MoldeRestaurantes("350000", "Restaurante nueva esperanza", R.drawable.restaurantexx3, "Restaurante Sabores del Pueblo:\n" +
