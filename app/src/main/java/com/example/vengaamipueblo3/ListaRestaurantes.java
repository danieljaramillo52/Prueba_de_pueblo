...
public class ListaRestaurantes extends AppCompatActivity {
    ...
    public void crearlista() {
        listaRestaurantes.add(new MoldeRestaurantes("250000", "Restaurante6", R.drawable.hoteles3, "Somos el mejor restaurante de sonson platos típicos, de toda colombia a los que tenemos acceso gracias a nuestros pisos termicos"));
        listaRestaurantes.add(new MoldeRestaurantes("350000", "Restaurante2", R.drawable.hotel4, "Restaurante Sabores del Pueblo:\n" +
